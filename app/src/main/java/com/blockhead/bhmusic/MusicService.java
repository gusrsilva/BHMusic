...
public class MusicService extends Service implements
    ...
    private MediaNotificationManager mNotMan;
    ...
    public Bitmap getSongCover() { return songCover; }
    public Song getCurrSong()
    {
        return songs.get(songPosn);
    }
    public Bitmap getSmallSongCover() { return smallCover; }
    public Bitmap getBlurredCover() { return blurredCover; }
    public Bitmap getSuperBlurredCover() { return superBlurredCover; }
    ...
    private void createNotification(){
        ...
        Intent contentIntent = new Intent(this, NowPlaying.class);
